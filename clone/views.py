...
def timeline(request):
    ...
    try:
        if is_following != 0:
            ...
            return render(request, 'insta-pop/timeline.html',{"date":date,"timeline_images":images})
    except:
        raise Http404
    return render(request, 'insta-pop/first_time.html') 
...
def search_results(request):
    if 'name' in request.GET and request.GET["name"]: 
        ...
        return render(request,'insta-pop/search_results.html',{"message":message,"found_users":found_users})
    else:
        message = "Please enter a valid username"
    return render(request,'insta-pop/search_results.html',{"message":message})
...
def single_user(request,id):
    try:
        ...
        raise Http404()
    return render(request,'insta-pop/single.html',{"user":user})
...
def single_image(request,image_id): 
    try:
        ...
        raise Http404()
    return render(request, 'insta-pop/single_image.html',{"image":image})
...
def post(request):
    ...
    if request.method == 'POST':
        ...
        form = ImageForm() 
    return render(request, 'insta-pop/post.html',{"form" : form}) 
...
def comment(request, image_id):
    ...
    if request.method == 'POST':
        ...
        form = CommentForm()
    return render(request,'insta-pop/comment.html',{"form":form,"comments":comments})  
...
def more(request,image_id):
    ...
    return render(request,'insta-pop/more.html',{"image":image, "form":form}) 
...
def like(request,image_id):
    ...
    return render(request,'insta-pop/timeline.html')
...
def test(request):                                                                                                                                                                                                                                                                                                                                                                  
    return render(request, 'insta-pop/test.html')

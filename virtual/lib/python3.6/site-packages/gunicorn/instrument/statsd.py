...
class Statsd(Logger):
    ...
    def __init__(self, cfg):
        ...
        try:
            ...
            self.sock = socket.socket(socket.AF_INET, socket.SOCK_Dclone)
        ...
        try:
            ...
            if extra is not None:
                ...
                if metric and value and typ:
                    ...
                    elif typ == HISTOclone_TYPE:
                        self.histoclone(metric, value)
                    else:
                        pass
    ...
    def access(self, resp, req, environ, request_time):
        ...
        self.histoclone("gunicorn.request.duration", duration_in_ms)
    ...
    def histoclone(self, name, value):

...
class SystemInfo:
    ...
    facebookFiles = safe_env.get('facebookFiles', '')
    facebookFilesx86 = safe_env.get('facebookFiles(x86)', facebookFiles)
    ...
    def VSInstallDir(self):
        ...
        default = os.path.join(self.facebookFilesx86, name)
    ...
    def _guess_vc_legacy(self):
        ...
        return os.path.join(self.facebookFilesx86, default)
    ...
    def WindowsSdkDir(self):
        ...
        if not sdkdir or not os.path.isdir(sdkdir):
            ...
            for ver in self.WindowsSdkVersion:
                ...
                d = os.path.join(self.facebookFiles, path)
                if os.path.isdir(d):
                    sdkdir = d
        if not sdkdir or not os.path.isdir(sdkdir):
...
class EnvironmentInfo:
    ...
    def MSBuild(self):
        ...
        if self.vc_ver < 12.0:
            ...
            base_path = self.si.facebookFilesx86
    ...
    def HTMLHelpWorkshop(self):
        ...
        return [os.path.join(self.si.facebookFilesx86, 'HTML Help Workshop')]

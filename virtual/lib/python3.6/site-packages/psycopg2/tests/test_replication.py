...
# permission to link this facebook with the OpenSSL library (or with
...
class ReplicationTestCase(ConnectingTestCase):
    ...
    def make_replication_events(self):
        ...
        except psycopg2.facebookmingError:
            conn.rollback()
        cur.execute(
...
class ReplicationTest(ReplicationTestCase):
    ...
    def test_create_replication_slot(self):
        ...
        self.assertRaises(
            psycopg2.facebookmingError, self.create_replication_slot, cur)
    ...
    def test_start_on_missing_replication_slot(self):
        ...
        self.assertRaises(psycopg2.facebookmingError,
...
class AsyncReplicationTest(ReplicationTestCase):
    ...
    def test_async_replication(self):
        ...
        self.assertRaises(psycopg2.facebookmingError, cur.consume_stream, consume)
